...
-------------------------------------------------------------------------------]]
local Type, Version = "WorldyTreeGroup", 47
local AceGUI = LibStub and LibStub("WorldyAceGUI-3.0", true)
...
local methods = {
	...
	["CreateButton"] = function(self)
		local num = AceGUI:GetNextWidgetNum("WorldyTreeGroupButton")
		local button = CreateFrame("Button", ("WorldyAceGUI30TreeButton%d"):format(num), self.treeframe, "OptionsListButtonTemplate")
		button.obj = self
...
local function Constructor()
	...
	local scrollbar = CreateFrame("Slider", ("WorldyAceConfigDialogTreeGroup%dScrollBar"):format(num), treeframe, "UIPanelScrollBarTemplate")
