--- **WorldyAceGUI-3.0** provides access to numerous widgets which can be used to create GUIs.
-- AceGUI is used by AceConfigDialog to create the option GUIs, but you can use it by itself
-- to create any custom GUI. There are more extensive examples in the test suite in the Ace3
-- stand-alone distribution.
--
-- **Note**: When using WorldyAceGUI-3.0 directly, please do not modify the frames of the widgets directly,
...
-- f:SetTitle("WorldyAceGUI-3.0 Example")
...
-- f:AddChild(btn)
-- @class file
-- @name WorldyAceGUI-3.0
-- @release $Id: WorldyAceGUI-3.0.lua 1288 2022-09-25 14:19:00Z funkehdude $
local ACEGUI_MAJOR, ACEGUI_MINOR = "WorldyAceGUI-3.0", 41
...
AceGUI.tooltip = AceGUI.tooltip or CreateFrame("GameTooltip", "WorldyAceGUITooltip", UIParent, "GameTooltipTemplate")
